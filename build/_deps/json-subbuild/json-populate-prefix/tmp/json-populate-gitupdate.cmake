...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v3.11.2"
  WORKING_DIRECTORY "/home/goaty/Documents/Projects/AngelGame/build/_deps/json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/goaty/Documents/Projects/AngelGame/build/_deps/json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/goaty/Documents/Projects/AngelGame/build/_deps/json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
